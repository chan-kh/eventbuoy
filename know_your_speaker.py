...
if prompt := st.chat_input("Ask anything about Rajesh"):
    ...
    with st.spinner("Please wait..."):
        ...
        response = create_question_answer(webbot_id=st.session_state['webbot_id'], conversation_id=conversation_id, question=prompt, model_name="gpt-3.5-turbo", instruction_id = 17192)
    conversation_id = st.session_state['active_conversation_id']
